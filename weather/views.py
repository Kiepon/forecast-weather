    ...
    if request.method == 'POST':
        ...
        if forecast_form.is_valid():
            ...
            try:
                ...
                coordinates = json_response['response']['GeoObjectCollection']['featureMember'][0]['GeoObject']['Point']['pos'].split()
            ...
            res = requests.get(f'https://api.weather.yandex.ru/v2/forecast?lat={lat}&lon={lon}&lang=ru_RU', headers=headers)
